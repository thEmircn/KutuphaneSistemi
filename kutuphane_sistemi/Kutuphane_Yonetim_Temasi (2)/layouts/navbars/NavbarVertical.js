...
// import routes file
import { Yönetim PaneliMenu } from "routes/Yönetim PaneliRoutes";
    ...
    return (
      <li className="nav-item">
        <Link
          ...
          data-bs-target="#navYönetim Paneli"
          aria-expanded={isCurrentEventKey ? true : false}
          aria-controls="navYönetim Paneli"
        >
  ...
  return (
    <Fragment>
      <SimpleBar style={{ maxHeight: "100vh" }}>
        ...
        >
          {Yönetim PaneliMenu.map(function (menu, index) {
            if (menu.grouptitle) {
              return (
