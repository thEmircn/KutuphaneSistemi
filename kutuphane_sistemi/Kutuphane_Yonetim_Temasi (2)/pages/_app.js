...
import DefaultYönetim PaneliLayout from 'layouts/DefaultYönetim PaneliLayout';

function MyApp({ Component, pageProps }) {
  const router = useRouter();
  const pageURL = process.env.baseURL + router.pathname;
  const title = "Dash UI - Next.Js Yönetici Yönetim Paneli Template";
  ...
  DefaultYönetim PaneliLayout : DefaultYönetim PaneliLayout) : DefaultYönetim PaneliLayout)
