...
/**
 *  All Yönetim Paneli Routes
 *
 *  Understanding name/value pairs for Yönetim Paneli routes
 *
...
export const Yönetim PaneliMenu = [
	{
		id: uuid(),
	...
	},
	{
		...
		icon: 'layers',
		children: [
			{ id: uuid(), link: '/pages/profile', name: 'Profil' },
			{ id: uuid(), link: '/pages/settings', name: 'Ayarlar'},
...
export default Yönetim PaneliMenu;
