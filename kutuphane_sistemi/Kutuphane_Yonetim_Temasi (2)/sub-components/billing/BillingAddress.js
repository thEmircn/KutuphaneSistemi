      ...
      >
        ...
        <Modal.Body>
          <Form className="row">
            ...
            <Col xs={12}>
              <Button type="submit" className="d-grid" >Kaydet Address</Button>
            </Col>
          </Form>
        </Modal.Body>
      </Modal>
                ...
                <div className="mb-3 mb-lg-0">
                  <Form.Check id="shippingBillingAddress1" >
                    ...
                    <Form.Check.Label>
                      ...
                      <Link href="#" className="me-2 link-success">Düzenle</Link>
                      <Link href="#" className="me-2 link-danger">Sil</Link>
